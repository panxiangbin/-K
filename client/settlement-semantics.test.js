...
const requiredJsxPatterns = [
  ...
  ['dynamic top action modifier', /settlement-top-action--\$\{position\}/],
  ['start action', /<TopButton position="start"[\s\S]*返回大厅<\/TopButton>/],
  ['end action', /<TopButton position="end"[\s\S]*退出房间<\/TopButton>/],
