...
assert.match(source, /data\.connectionState|dataset\.connectionState/);
...
assert.match(css, /data-connection-state='offline'/);
assert.match(css, /data-connection-state='recovering'/);
